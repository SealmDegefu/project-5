...
checklist5 = Checklist.create!(image_url: "https://media.architecturaldigest.com/photos/6019c5ff571b077c679a7092/4:3/w_4000,h_3000,c_limit/Cora_Premium.jpg",name: "Flower Arrangement", description: "This list will go through everything you need to checkoff to have your flower arrangments")
...
ChecklistItem.create!(list: "First thing is first, decide the theme of your wedding so you can decide what the color of the dress will be", checklist_id: checklist2.id)
ChecklistItem.create!(list: "Decide what your bridesmaids dress will be and confirm with the bridesmaids it will work for everyone ", checklist_id: checklist2.id)
ChecklistItem.create!(list: "Make sure the bridesmaids will get sized and fitted early on", checklist_id: checklist2.id)
